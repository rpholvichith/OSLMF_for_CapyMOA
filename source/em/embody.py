...
def _em_step_body_row(Z_row, r_lower_row, r_upper_row, sigma, num_ord_updates=1):
    ...
    #print("EM_BODY_ROW setting up indices and sigma.")
    # setting up index lists
    ...
    #print("EM_BODY_ROW computing sigma_obs_obs_inv.")
    # compute inverse of sigma_obs_obs
    ...
    #print("EM_BODY_ROW updating ordinals.")
        ...
        for update_iter in range(num_ord_updates):
            ...
            for ind in range(len(ord_obs_indices)):
                ...
                if np.isfinite(mean):
                    #print("\t\t\tFinite mean")
                    Z_row[j] = mean
                #print("\t\tUpdated feature", ind)

    #print("EM_BODY_ROW imputing missing continuous features.")
    # MISSING ELEMENTS
